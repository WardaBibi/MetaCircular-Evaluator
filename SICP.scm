...
(define (eval exp env)
  ...
  (cond ((self-evaluating? exp)(display 'self) 
         exp)
        ((variable? exp) 
         (begin (display 'variable) (display exp) (newline)
            (lookup-variable-value exp env)))
        ((quoted? exp)
         (begin (display 'quoted?) (display exp) (newline)
         (text-of-quotation exp)))
        ((assignment? exp) (display 'assignment) 
         (eval-assignment exp env))
        ((definition? exp)  (display 'def)
...
(define (definition-variable exp)
  (cond ( (symbol? (cadr exp))
      (cadr exp) (newline) (display "cadr exp ") (display (cadr exp)))
      (else (caadr exp) (newline) (display "caadr exp") (display (caadr exp)))))
